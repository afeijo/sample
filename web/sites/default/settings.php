...
$databases['default']['default'] = [
  ...
  'host' => getenv('MYSQL_HOSTNAME') ?? 'localhost',
...
// generate a rash salt
$settings['hash_salt'] = hash('sha256', 'FeijoSampleSite2023' . __FILE__);
...
if (file_exists($local_path = "$app_root/$site_path/settings.local.php")) {
  require $local_path;
}
